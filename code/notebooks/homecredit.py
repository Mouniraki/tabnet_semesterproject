...
model_zoo = {
    ...
    "tabnet_clean": utils.load_torch_model(
        "../models/homecredit_final/clean.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_cb_10_wo": utils.load_torch_model(
        "../models/homecredit_final/l1_10.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_cb_20_wo": utils.load_torch_model(
        "../models/homecredit_final/l1_20.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_cb_200_wo": utils.load_torch_model(
        "../models/homecredit_final/l1_200.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_cb_400_wo": utils.load_torch_model(
        "../models/homecredit_final/l1_400.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_cb_1000_wo": utils.load_torch_model(
        "../models/homecredit_final/l1_1000.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
    "tabnet_ub_1000000": utils.load_torch_model(
        "../models/homecredit_final/ub_1000000.0.pt",
        dataset="home_credit",
        model_label="tabnet_homecredit",
        device="cuda",
    ),
...
cost_bounds = [100, 1000, None, "AMT_CREDIT"]
...
plt.tight_layout()
plt.savefig("../images/homecredit_pgd.pdf")
