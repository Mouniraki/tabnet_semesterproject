...
do
    ...
    do
        ...
        do
            ...
            python3 eval.py --dataset ieeecis --model tabnet_ieeecis --model_path $PATH_TO_MODELS/ieeecis_${n_steps}_${n_shared}_${n_ind}_16_16_0_0.pt --n_steps $n_steps --n_shared $n_shared --n_ind $n_ind --utility_type average-attack-cost
        done
    done
done